...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(1200, 1200, "My funny window", NULL, NULL);
    ...
    Texture texture(0, "../textures/cookie.png", 16, 16, 4);
    GLuint tex0Uni = glGetUniformLocation(shaderProgram.ID, "tex0");

    shaderProgram.Activate();
    glUniform1i(tex0Uni, 0);

    GLuint posChangeID = glGetUniformLocation(shaderProgram.ID, "posChange");
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        double posChange = sin(timeValue);
        shaderProgram.Activate();

        glUniform1f(posChangeID, posChange);
